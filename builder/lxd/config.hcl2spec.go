...
type FlatConfig struct {
	...
	OutputAlias         []string          `mapstructure:"output_alias" required:"false" cty:"output_alias" hcl:"output_alias"`
	...
	Profiles            []string          `mapstructure:"profiles" cty:"profiles" hcl:"profiles"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"output_alias":               &hcldec.AttrSpec{Name: "output_alias", Type: cty.List(cty.String), Required: false},
		...
		"profiles":                   &hcldec.AttrSpec{Name: "profiles", Type: cty.List(cty.String), Required: false},
